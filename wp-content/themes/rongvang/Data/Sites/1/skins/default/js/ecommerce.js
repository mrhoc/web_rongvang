...
$(document).ready(function () {
    ...
    $(".btn-view-more").click(function () {
        var newsTitle = $(this).parents(".content").find('.title');
        $(".hdsolutiontype input").val(newsTitle.text().trim());
    });
    ...
    // $(".contact-form input[type='submit']").on("click", function (e) {
        ...
        // var firstName = $(".contact-form").find(".txt-fullname input[type='text']");
        // var phone = $(".contact-form").find(".txt-phone input[type='text']");
        // var email = $(".contact-form").find(".txt-email input[type='text']");
        // var address = $(".contact-form").find(".txt-address input[type='text']");
        // var message = $(".contact-form").find(".txt-message textarea");
        // if (!(firstName.val() && phone.val() && email.val()))
            // return;
        // var urladd = siteRoot + "/Custom/Services/CustomService.aspx";
        // var data = {
            // 'method': 'SubmitContactHubSpot',
    ...
    function ProcessAjax(pageurl) {
        ...
        $.ajax({
            url: pageurl, data: { isajax: true }, success: function (data) {
                ...
                $('.productpager').remove();
                $(data).find('.productpager').insertAfter($('.ajaxresponse'));
				if($('.product-change-view ul li.active a').attr('data-view') == 1){
					
					$('.ajaxresponse .product-view-grid').addClass('show');
				}
				if($('.product-change-view ul li.active a').attr('data-view') == 2){
					
					$('.ajaxresponse .product-view-list').addClass('show');
				}
            }
        });
