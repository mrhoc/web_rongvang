<?php get_header() ?>
	<main>
		...
		<div id="ctl00_divCenter" class="middle-fullwidth">
			<div class="Module Module-291">
				<div class="ModuleContent">
					<section id="gioi-thieu-1" class="uk-section-large about-1"
					         style="background-image: url(<?php bloginfo('template_directory'); ?>/Data/Sites/1/skins/default/img/bg-6.jpg)">
						<div class="uk-container">
							<div class="section-title section-title-white uk-text-center">
								<h2>Giới thiệu</h2>
							</div>
							<div class="section-desc uk-text-center">
								<p></p>
        ...
        <span class="lnr lnr-chevron-down">
								...
								<div class="swiper-container swiper-container-initialized swiper-container-vertical">
									<div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
										<div class="swiper-slide swiper-slide-active" style="height: 333.333px;">
											<div class="item uk-grid uk-grid-collapse" uk-grid="">
										...
										<div class="swiper-slide swiper-slide-next" style="height: 333.333px;">
											<div class="item uk-grid uk-grid-collapse" uk-grid="">
												<div class="wrapper-empty">
												</div>
												<div class="wrapper uk-width-1-3@l">
										...
										<div class="swiper-slide" style="height: 333.333px;">
											<div class="item uk-grid uk-grid-collapse" uk-grid="">
												<div class="wrapper-empty uk-first-column">
												</div>
												<div class="wrapper uk-width-1-3@l">
												...
												<div class="wrapper uk-width-1-3@l">
													<div class="content-wrapper">
														...
														<ul>
															...
															<li style="text-align: justify;">Tính đến cuối năm 2019 TTC
																Energy tiếp tục là một trong các công ty hàng đầu thị
																trường Điện mặt trời áp mái với tổng công suất lên tới
																50 MWP<br>
															</li>
														</ul>
													</div>
												...
												<div class="wrapper uk-width-1-3@l">
													<div class="content-wrapper">
														...
														<p style="text-align: justify;">Ngày 30/6/2016, Tập đoàn TTC
															...
															chiến lược vào Công ty CP Điện Gia Lai đưa Công ty trở thành
															một nhà phát triển năng lượng tái tạo kiểu mẫu tại Việt Nam.<br>
														</p>
														<div style="text-align: justify;">&nbsp;</div>
													</div>
												</div>
												...
												<div class="wrapper uk-width-1-3@l">
													<div class="content-wrapper">
														...
														<p style="text-align: justify;">Với tiền thân là Công ty Cổ phần
															...
															TTC - một Tập đoàn kinh tế tư nhân đa ngành, GEC được xác
															định là đơn vị tiên phong, hạt nhân của Tập đoàn trong lĩnh
															vực Năng lượng.<br>
														</p>
														<div style="text-align: justify;">&nbsp;</div>
													</div>
